    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <div id="logo">
                ...
                <!-- <a href="index.html"><img src=" {{ asset('index') }}/assets/img/logo.png" alt="" title="" /></a>-->
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="100">
                        <div class="feature-block">
                            ...
                            <img src=" {{ asset('index') }}/assets/img/svg/cloud.svg" alt="img">
                    ...
                    <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="200">
                        <div class="feature-block">
                            ...
                            <img src=" {{ asset('index') }}/assets/img/svg/planet.svg" alt="img">
                    ...
                    <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="300">
                        <div class="feature-block">
                            ...
                            <img src=" {{ asset('index') }}/assets/img/svg/asteroid.svg" alt="img">
            ...
            <div class="container" data-aos="fade-up">
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-5 col-lg-3">
                        <img src=" {{ asset('index') }}/assets/img/about-img.png" alt="About" data-aos="zoom-in"
                            data-aos-delay="100">
                    </div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-block">
                            <img src=" {{ asset('index') }}/assets/img/svg/paint-palette.svg" alt="img">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-block">
                            <img src=" {{ asset('index') }}/assets/img/svg/vector.svg" alt="img">
                            <h4>Retina Ready</h4>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-block">
                            <img src=" {{ asset('index') }}/assets/img/svg/design-tool.svg" alt="img">
                            <h4>easy to use</h4>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-block">
                            <img src=" {{ asset('index') }}/assets/img/svg/cloud-computing.svg" alt="img">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-block">
                            <img src=" {{ asset('index') }}/assets/img/svg/pixel.svg" alt="img">
                            <h4>Perfect Pixel</h4>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="feature-block">
                            <img src=" {{ asset('index') }}/assets/img/svg/code.svg" alt="img">
                            <h4>clean codes</h4>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
                        </div>
                    </div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="screens-slider swiper">
                    <div class="swiper-wrapper align-items-center">
                        <div class="swiper-slide"><img src=" {{ asset('index') }}/assets/img/screen/1.jpg"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src=" {{ asset('index') }}/assets/img/screen/2.jpg"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src=" {{ asset('index') }}/assets/img/screen/3.jpg"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src=" {{ asset('index') }}/assets/img/screen/4.jpg"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src=" {{ asset('index') }}/assets/img/screen/5.jpg"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src=" {{ asset('index') }}/assets/img/screen/6.jpg"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src=" {{ asset('index') }}/assets/img/screen/7.jpg"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src=" {{ asset('index') }}/assets/img/screen/8.jpg"
                                class="img-fluid" alt=""></div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="100">
                        <div class="team-block bottom">
                            <img src=" {{ asset('index') }}/assets/img/team/1.jpg" class="img-responsive"
                                alt="img">
                    ...
                    <div class="col-md-6 col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="200">
                        <div class="team-block bottom">
                            <img src=" {{ asset('index') }}/assets/img/team/2.jpg" class="img-responsive"
                                alt="img">
                            <div class="team-content">
                                <ul class="list-unstyled">
                                    <li><a href="#"><i class="bi bi-facebook"></i></a></li>
                    ...
                    <div class="col-md-6 col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="300">
                        <div class="team-block bottom">
                            <img src=" {{ asset('index') }}/assets/img/team/3.jpg" class="img-responsive"
                                alt="img">
                            <div class="team-content">
                                <ul class="list-unstyled">
                                    <li><a href="#"><i class="bi bi-facebook"></i></a></li>
                    ...
                    <div class="col-md-6 col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="400">
                        <div class="team-block bottom">
                            <img src=" {{ asset('index') }}/assets/img/team/4.jpg" class="img-responsive"
                                alt="img">
                            <div class="team-content">
                                <ul class="list-unstyled">
                                    <li><a href="#"><i class="bi bi-facebook"></i></a></li>
                ...
                <div class="row" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="block-blog text-left">
                            <a href="#"><img src=" {{ asset('index') }}/assets/img/blog/blog-image-1.jpg"
                                    alt="img"></a>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="block-blog text-left">
                            <a href="#"><img src=" {{ asset('index') }}/assets/img/blog/blog-image-2.jpg"
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="block-blog text-left">
                            <a href="#"><img src=" {{ asset('index') }}/assets/img/blog/blog-image-3.jpg"
                                    class="img-responsive" alt="img"></a>
                            <div class="content-blog">
                                <h4><a href="#">whats isthe difference between good and bat typography</a></h4>
                                <span>05, juin 2017</span>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="footer-logo">
                        ...
                        <p> Tiketing adalah solusi terbaik untuk memperbaiki masalah hardware dan software pada
                            ...
                            dan mudah tanpa harus membuang waktu atau biaya yang besar. Tim kami terdiri dari teknisi
                            ahli yang siap membantu Anda dengan masalah apa pun, mulai dari perbaikan perangkat keras
                            hingga perangkat lunak. Dapatkan layanan terbaik dan hemat waktu dengan Tiketing!</p>
